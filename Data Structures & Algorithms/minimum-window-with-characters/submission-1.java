class Solution {
    public String minWindow(String s, String t) {
        ...
        while(r < n && l <= r) {
            cnt2[s.charAt(r)]++;
            // find a valid window , once we found it , 
            // we will try to shrink from left l++ to find minimum window in valid one 
            // after shrinking once window becomes invalid, we will move r again r++ to from valid one 
